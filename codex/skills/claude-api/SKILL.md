...
Legacy skill для явных Anthropic/Claude задач. Для Codex, OpenAI API, Codex plugins и миграции Cloudy/Claude workflow используй `codex/skills/openai-codex/SKILL.md`.
