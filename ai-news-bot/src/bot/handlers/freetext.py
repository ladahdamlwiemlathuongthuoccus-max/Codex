...
PATTERNS = {
    "digest": [
        r"дайджест", r"новости", r"что нового", r"сводк", r"обзор",
        r"покажи новости", r"собери новости", r"расскажи",
    ],
    "force_fetch": [
    ...
    "sources": [
        r"источник", r"откуда", r"каналы", r"подписк",
    ],
    "stats": [
        r"статистик", r"сколько", r"stats",
    ],
    "help": [
